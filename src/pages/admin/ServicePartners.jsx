...
export default function ServicePartners() {
    ...
    const fetchItems = useCallback(async (page = 1, limit = 10, search = '') => {
        ...
        try {
            ...
            setError(err.response?.data?.message || err.message || 'Failed to fetch service partners');
            setItems([]);
        } finally {
            setLoading(false);
        }
    ...
    useEffect(() => {
        fetchItems(pagination.page, pagination.limit, searchTerm);
    }, [pagination.page, pagination.limit, searchTerm, fetchItems]);
    ...
    const confirmDelete = async () => {
        ...
        setDeleting(true);
        try {
            await api.delete(`${API_BASE}/${selected._id}`);
                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-4 min-w-0">
                        ...
                        <div className="text-sm text-gray-500 truncate max-w-[220px]">
                            {row.description
                                ? `${row.description.substring(0, 48)}${row.description.length > 48 ? '…' : ''}`
                                : '—'}
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <PageHeader
                ...
                subtitle="Manage partner logos and details shown on the site"
                actions={
                    <Link
                        to="new"
            ...
            {showDeleteModal && selected && (
                <div className="fixed inset-0 bg-gray-600/50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                        <h3 className="text-lg font-medium text-gray-900">Delete service partner</h3>
